...
class RelatorioService
{
     ...
     */
    public function __construct(RelatorioRepository $relatorioRepository, ImagemRepository $imagemRepository)
    {
    ...
    {
        $relatorios = $this->relatorioRepository->paginate();
