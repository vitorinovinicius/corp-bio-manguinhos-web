...
/**
 * Class PlanOccurrenceCriteriaCriteria.
 *
 * @package namespace App\Criteria;
 */
class PlanOccurrenceCriteria implements CriteriaInterface
{
    /**
    ...
    public function apply($model, RepositoryInterface $repository)
    {
        ...
        if(\Auth::user()->contractor_id) {
            $model = $model->where('contractor_id',\Auth::user()->contractor_id); //Para não aparecer nada
        }
