<?php
    ...
    /**
     * Class OccurrenceToAdjustCriteria.
     *
     * @package namespace App\Criteria;
     */
    class OccurrenceToAdjustCriteria implements CriteriaInterface
    {
        /**
        ...
        public function apply($model, RepositoryInterface $repository)
        {
            ...
            $model = $model->where("occurrences.approved", "=", 3); // Solicitado ajuste
