...
class OccurrenceTypeFormRequest extends FormRequest
{
    /**
...
//                    'boolean'=>'boolean|nullable',
                    'occurrence_type_id'=>'numeric|required|exists:occurrence_types,id'.\Tenant::ruleExists(),
                    'form_id'=>'numeric|required|exists:forms,id'.\Tenant::ruleExists(),
                ];
            }
            case 'PUT': {
