...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div
                class="card-content collapse {{(app('router')->is("export.index") || app('request')->exists('scheduled_date') ) ? "show" : "" }}">
                <div class="card-body">
...
{{--                                </div>--}}
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="client_number">Nº do Cliente</label>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <select class="select2" id="uf" name="uf" data-placeholder="UF">
                                            <option></option>
                                            @forelse($occurrence_clients->unique('uf') as $key=>$value)
                                                <option
                                                    value="{{$value->uf}}" {{((app('request')->input('uf')==$value->uf) ? "selected":"")}}>{{$value->uf}}</option>
                                            @empty
                                            @endforelse
                                        </select>
                                    </div>
                            ...
                            @include('helpers.filter_occurrence_export')
                            ...
                            <div class="row">
                                <div class="col-md-12 d-flex justify-content-end">
                                    ...
                                    @endif
                                    <a href="/{{Route::getCurrentRoute()->uri()}}" class="btn btn-link pull-right"><i
