...
@section('content-header')
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Seções do formulário / Editar #{{$form->id}}</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        <li class="breadcrumb-item"><i class="bx bx-home-alt"></i> Home</li>
                        <li class="breadcrumb-item">Seções do formulário</li>
...
@section('content')
    ...
    <form action="{{ route('form_sections.update', $form_section->uuid) }}" method="POST">
        ...
        <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Nome</label>
                                    <input type="text" class="form-control" required name="name" value="{{ old('name', $form_section->name) }}" placeholder="Nome" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Descrição</label>
                                    <textarea class="form-control" name="description" placeholder="Descrição" autocomplete="off" rows="8">{{ old('description', $form_section->description) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            @include("form_sections.includes.adicionar_campos",["edit"=>true])
        </div>
            ...
            <div class="col-md-12">
                <div class="box box-default">
                    <div class="box-footer">
                        ...
                        <a class="btn btn-link pull-right" href="{{ route('forms.show', $form->uuid) }}"><i class="bx bx-arrow-back"></i> Voltar</a>
                    </div>
                </div>
            </div>
        </div>
