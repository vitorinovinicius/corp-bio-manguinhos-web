...
@section('content-header')
    <div class="content-header-left col-10 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Tipo de OS - {{ $occurrence_type->name }} - Desassociar Habilidades</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        <li class="breadcrumb-item"><i class="bx bx-home-alt"></i> Home</li>
                        <li class="breadcrumb-item">Tipo de OS</li>
                        <li class="breadcrumb-item active">Remover Habilidades</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-12 d-flex justify-content-end">
                                        ...
                                        <a href="{{ route('occurrence_types.desassociate.skill', $occurrence_type->uuid) }}" class="btn btn-link pull-right"><i class="bx bx-eraser"></i> Limpar</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <div class="card-content">
                    <div class="card-body">
                        @if($skills->count())
                            <div class="row">
                                <div class="col-12">
                                    <a class="btn btn-warning pull-right btn-attr-operator" href="#" id="btn-attr-operator"><i class="bx bx-minus"></i> Desassociar</a>
                                </div>
                            </div>
        ...
        $(function () {
            ...
            $(document).on('click', '.btn-attr-operator', function (e) {
                ...
                if (ids.length == 0) {
                    ...
                    jQuery.ajax({
                        type: 'PUT',
                        url: '{!!  route('occurrence_types.desassociate.skill.store', [$occurrence_type->uuid, 'flag'=> 1]) !!} ',
                        data: "ids=" + ids,
