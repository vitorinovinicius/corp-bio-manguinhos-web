                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="7" class="form-control" id="obs_empreiteira" name="obs_empreiteira" placeholder="Observação da Ocorrência">{{ old('obs_empreiteira') }}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" autocomplete="off" class="form-control" id="client_name" name="name" value="{{ old('name') }}" placeholder="Nome completo do cliente" required>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label>Número externo do cliente</label>
                                                    <input type="text" autocomplete="off" class="form-control" id="client_number" name="client_number" value="{{ old('client_number') }}" placeholder="Nº cliente">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" autocomplete="off" class="form-control" id="cpf_cnpj" name="cpf_cnpj" value="{{ old('cpf_cnpj') }}" placeholder="CPF ou CNPJ">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label>CEP</label>
                                                    <div>
                                                        <input type="text" autocomplete="off" class="form-control" style="width: calc(100% - 95px);display: inline-block; margin-right: 6px;" id="cep" name="cep" value="{{ old('cep') }}" placeholder="CEP" required>
                                        ...
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" autocomplete="off" class="form-control" id="address" name="address" value="{{ old('address') }}" placeholder="Endereço" required>
                                                </div>
                                            </div>
                                            <div class="col-2">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="form-group">
                                                    <label>Bairro</label>
                                                    <input type="text" autocomplete="off" class="form-control" id="district" name="district" value="{{ old('district') }}" placeholder="Bairro" required>
                                                </div>
                                            </div>
                                            <div class="col-5">
                                                <div class="form-group">
                                                    <label>Cidade</label>
                                                    <input type="text" autocomplete="off" class="form-control" id="city" name="city" value="{{ old('city') }}" placeholder="Cidade" required>
                                                </div>
                                            </div>
                                            <div class="col-2">
                                                <div class="form-group">
