...
<style nonce="{{ csp_nonce() }}">
    * {
    ...
    html .content {
        ...
        margin-right: calc(0% + 1.5rem) !important;
    }
    ...
    .card-body {
        padding: 1.7rem 1.7rem 1rem 1.7rem !important;
    }
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="form-control-static">{{$occurrence->occurrence_type->name}}</p>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
