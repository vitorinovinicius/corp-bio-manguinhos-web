...
@section('content-header')
    <div class="content-header-left col-10 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Permissions / Exibir #{{$permission->id}}</h5>
    ...
    <div class="col-2 d-flex justify-content-end align-items-center">
        <form action="{{ route('permissions.destroy', $permission->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Deseja realmente excluir esse item?')) { return true } else {return false };">
            ...
            <div class="btn-group pull-right" role="group" aria-label="...">
                <a class="btn btn-warning btn-group" role="group" href="{{ route('permissions.edit', $permission->id) }}"><i class="bx bx-edit"></i> Editar</a>
...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="box-title">Dados da permissão</h3>
                </div>
    ...
    <a class="btn btn-primary" href="{{ route('permissions.index') }}"><i class="bx bx-arrow-back"></i> Voltar</a>
