...
<section class="content">
    ...
    <div class="col-md-12">
        <img src="{{$occurrence->contractor->logo_cabecalho}}" alt="" class="logo">
    </div>
            ...
            <div class="box box-solid box-danger">
                ...
                <div class="box-body occurrence-description">
                    <div class="well col-md-12">
                        ...
                        <p>Segue em anexo detalhamento da ordem de serviço prestado. Agradecemos por utilizar nossos serviços !</p>
