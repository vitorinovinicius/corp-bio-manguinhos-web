...
@section('content-header')
    <div class="content-header-left col-10 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Técnico - {{ $operator->name }} - Desassociar Equipamentos</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        <li class="breadcrumb-item"><i class="bx bx-home-alt"></i> Home</li>
                        <li class="breadcrumb-item">Técnico</li>
                        <li class="breadcrumb-item active">Desassociar Equipamentos</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card-content">
                    <div class="card-body">
                        @if($equipments->count())
                            <div class="row">
                                <div class="col-12">
                                    <a class="btn btn-warning pull-right" href="#" id="btn-attr-operator"><i class="bx bx-plus"></i> Desassociar</a>
                                </div>
                            </div>
        ...
        $(function () {
            ...
            $(document).on('click', '#btn-attr-operator', function (e) {
                ...
                if (ids.length == 0) {
                    ...
                    jQuery.ajax({
                        type: 'POST',
                        url: '{!!  route('users.desassociate.equipment.store', [$operator->uuid]) !!} ',
                        data: "ids=" + ids,
