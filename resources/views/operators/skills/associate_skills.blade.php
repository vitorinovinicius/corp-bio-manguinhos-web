...
@section('content-header')
    <div class="content-header-left col-10 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Técnico - {{ $operator->name }} - Atribuir Habilidades</h5>
...
@section('content')
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-12 d-flex justify-content-end">
                                        ...
                                        <a href="{{ route('users.associate.skill', $operator->uuid) }}" class="btn btn-link pull-right"><i class="bx bx-eraser"></i> Limpar</a>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <a href="{{ route('users.associate.skill', $operator->uuid) }}" class="btn btn-primary pull-right"><i class="bx bx-fast-backward"></i> Voltar</a>
        ...
        $(function () {
            ...
            $(document).on('click', '#btn-attr-operator', function (e) {
                ...
                if (ids.length == 0) {
                    ...
                    jQuery.ajax({
                        type: 'POST',
                        url: '{!!  route('users.associate.skill.store', [$operator->uuid, 'flag'=> 1]) !!} ',
                        data: "ids=" + ids,
