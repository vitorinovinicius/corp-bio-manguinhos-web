                                ...
                                <div class="card-body">
                                    <form class="mb-2" method="POST" action="{{ url('/password/reset') }}">
                                        ...
                                        <div class="form-group">
                                            <label class="text-bold-600" for="exampleInputPassword1">Nova Senha</label>
                                            <input id="password" type="password" class="form-control" name="password" placeholder="Nova Senha" required>
                                        </div>
                                        <div class="form-group mb-2">
                                            <label class="text-bold-600" for="exampleInputPassword2">Confirmar Nova Senha</label>
                                        ...
                                        <button type="submit" class="btn btn-primary glow position-relative w-100">Resetar senha<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>
